...
class LNAPLinkedInOAuth2 extends LNAPOAuth2 {
	...
	public function getAdminCompanies(){
		...
		$params['url'] = "https://api.linkedin.com/v2/companies:({$request})";
		$params['method']='get';
		$params['args']['format']='json';
		$params['args']['count']=100;
	...
	public function shareStatus($args=array()){
		$params['url'] = 'https://api.linkedin.com/v2/ugcPosts';//https://api.linkedin.com/v2/people/~/shares
		$params['method']='post';
		$params['headers']['Authorization']='Bearer '.$this->access_token;
		...
		//print_r($params['args']);die;
		$result =  $this->makeRequest($params);
		return json_decode($result,true);
			}
	public function xyz_lnap_fetch_user_data($args=array()){
		$params['url'] = 'https://api.linkedin.com/v2/me';
		$params['method']='get';
		$params['headers']['Authorization']='Bearer '.$this->access_token;
		$params['headers']['Content-Type']='application/json';
	...
	public function postToCompany($company_id,$content=array()){
		$params['url'] = 'https://api.linkedin.com/v2/companies/'.$company_id.'/shares';
		$params['method']='post';
		$params['headers']['Content-Type']='application/json';
		$params['headers']['x-li-format']='json';
