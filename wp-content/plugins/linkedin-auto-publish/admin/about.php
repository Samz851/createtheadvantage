...
<p style="text-align: justify">
 ...
 <table class="xyz-premium-comparison" cellspacing=0 style="width: 99%;">
	...
	<tr>
		<td>Hash Tags support for Facebook, Twitter, Linkedin, Tumblr and Pinterest</td>
		<td><img src="<?php echo plugins_url("images/cross.png",XYZ_LNAP_PLUGIN_FILE);?>">
		</td>
		<td><img src="<?php echo plugins_url("images/tick.png",XYZ_LNAP_PLUGIN_FILE);?>">
		</td>
	...
	<tr>
		...
		<td>SMAPSOLUTIONS API package for 1 year, worth 10 USD(1 linkedin account @ 25 api per day)</td>
		<td><img src="<?php echo plugins_url("images/cross.png",XYZ_LNAP_PLUGIN_FILE);?>">
		</td>
	...
	<tr>
		<td>Purchase</td>
		<td></td>
		<td style="padding: 2px" colspan='2' ><a target="_blank"href="https://xyzscripts.com/wordpress-plugins/social-media-auto-publish/purchase"  class="xyz-lnap-buy-button">Buy Now</a>
		</td>
	</tr>
</table>
<br/>
