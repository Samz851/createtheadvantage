...
if(isset($_GET['action']) && $_GET['action']=="edit" && !empty($_GET['post']))  /// empty check added for fixing client scenario
	...
	if(get_option('xyz_lnap_lnaf')==0 && get_option('xyz_lnap_lnpost_permission')==1 && (get_option('xyz_lnap_ln_share_post_company')!=''|| get_option('xyz_lnap_lnshare_to_profile')==1))
...
<tr><td colspan="2" valign="top">&nbsp;</td></tr>
	...
	<tr valign="top">
	 ...
	 <td  class="switch-field">
		<label id="xyz_lnap_lnpost_permission_yes"><input type="radio" name="xyz_lnap_lnpost_permission" id="xyz_lnap_lnpost_permission_1" value="1" <?php if($post_permission==1) echo 'checked';?>/>Yes</label>
		<label id="xyz_lnap_lnpost_permission_no"><input type="radio" name="xyz_lnap_lnpost_permission" id="xyz_lnap_lnpost_permission_0" value="0"  <?php if($post_permission==0) echo 'checked';?>/>No</label>
	 </td>
	</tr>
	...
	<td>
		<select id="xyz_lnap_ln_shareprivate" name="xyz_lnap_ln_shareprivate" >
		 <option value="0" <?php  if($xyz_lnap_ln_shareprivate==0) echo 'selected';?>>Public</option>
		 <option value="1" <?php  if($xyz_lnap_ln_shareprivate==1) echo 'selected';?>>Connections only</option>
		</select>
	</td></tr>
<?php }?>
	...
	<tr valign="top" id="lnap_lnpm">
		<td style="padding-left: 15px;">Posting method</td>
		<td>
		<select id="xyz_lnap_lnpost_method" name="xyz_lnap_lnpost_method">
				<option value="1"
	<?php  if($xyz_lnap_lnpost_method==1) echo 'selected';?>>Simple text message</option>
				<option value="2"
	<?php  if($xyz_lnap_lnpost_method==2) echo 'selected';?>>Attach your blog post </option>
		</select>
		</td>
	</tr>
	</table>
