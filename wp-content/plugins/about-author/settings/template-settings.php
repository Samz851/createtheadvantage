	...
	<ul id="temp_menu">
		<li>
			<label class="lbl_temp arrow-left ">
				...
				<span><?php esc_html_e('Template 1', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 2', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 3', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 4', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 5', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 6', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 7', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 8', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 9', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
		...
		<li>
			<label class="lbl_temp">
				...
				<span><?php esc_html_e('Template 10', 'WL_ABTM_TXT_DM' ); ?></span>
			</label>
		</li>
	</ul>
</div>
