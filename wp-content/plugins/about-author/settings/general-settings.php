...
if(isset($ABT_Settings[0])) {
	...
	if(isset($ABT_Settings[0]['About_me_web_site_url'])){
		$About_me_web_site_url = $ABT_Settings[0]['About_me_web_site_url'];
	}else{
...
<table class="form-table aap_layout_setting"  >
	<tr>
		<td colspan="2">
			<label class="lbl"><?php esc_html_e('Profile Image Layout', 'WL_ABTM_TXT_DM' ); ?></label>
	    </td>
	</tr>
	<tr>
		<th colspan="2">  
	...
	<tr>
		<td colspan="2">
			<label class="lbl"><?php esc_html_e('Profile Image Layout settings','WL_ABTM_TXT_DM' ); ?></label>
		</td>
	</tr>
	<tr>
		<th>
			<label><?php esc_html_e('Border style', 'WL_ABTM_TXT_DM'); ?></label>
		</th>
	...
	<tr>
		<th><label><?php esc_html_e('Border size', 'WL_ABTM_TXT_DM' ); ?></label></th>
		<td>
			...
			<span id="img_bdr_span_value" name="img_bdr_span_value" class="volum4" ><?php echo esc_html($bdr_size);?><span>
		</td>
	</tr>
	<tr>
	...
	<tr class="co_lo_hi_d" style="<?php echo esc_attr($d_n_t); ?>">
		<td colspan="2">
			<label class="lbl"><?php esc_html_e('BackgroundColor option', 'WL_ABTM_TXT_DM' ); ?></label>
		</td>
	</tr>

	<tr class="co_lo_hi_d" style=" <?php echo esc_attr($d_n_t); ?>" >
		<th><label ><?php esc_html_e('BackgroundColor', 'WL_ABTM_TXT_DM' ); ?></label></th>
		<td>
			<p>
	...
	<tr> 
		<td colspan="2">
			<label class="lbl"><?php esc_html_e('Name Text Settings', 'WL_ABTM_TXT_DM' ); ?></label>
		</td>
	</tr>
	<tr>
		<th><label> <?php esc_html_e('Name Text', 'WL_ABTM_TXT_DM' ); ?></label></th>
		<td>
	...
	<tr><td colspan="2"><label class="lbl"><?php esc_html_e('Website Text Settings', 'WL_ABTM_TXT_DM' ); ?></label></td></tr>
	<tr>
		<th><label> <?php esc_html_e('Website Name Text', 'WL_ABTM_TXT_DM' ); ?></label></th>
	...
	<tr>
		<th><label> <?php esc_html_e('Website url', 'WL_ABTM_TXT_DM' ); ?></label></th>
		<td>
	...
	<tr>
		<th><label><?php esc_html_e('Font size', 'WL_ABTM_TXT_DM' ); ?></label></th>
		<td><input type="range" class="slider" min="12" max="40" step="1" value="<?php if(!isset($weblink_font_size))  { echo esc_attr($weblink_font_size = "20"); } else { echo esc_attr($weblink_font_size); } ?>" data-orientation="vertical" id="weblink_font_size" name="weblink_font_size"   oninput="outputUpdate2(value);"> <span id="weblink_set_span_value"name="weblink_set_span_value"class="volum2" ><?php echo esc_html($weblink_font_size);?><span>
		</td>
	</tr>
	<tr>
		<th><label><?php esc_html_e('Website Link Color', 'WL_ABTM_TXT_DM' ); ?></label></th>
	...
	<tr>
		<td colspan="2">
			<label class="lbl"><?php esc_html_e('Description Text Settings', 'WL_ABTM_TXT_DM' ); ?></label>
		</td>
	</tr>
	<tr>
		<th><label> <?php esc_html_e('Description Text', 'WL_ABTM_TXT_DM' ); ?></label></th>
		<td>
	...
	<tr>
		<td colspan="2">
			<label class="lbl"><?php esc_html_e('Social link Settings', 'WL_ABTM_TXT_DM' ); ?></label>
		</td>
	</tr>
	<tr>
		<th><label><a target="_blank" style="text-decoration: none;"><i class="fab fa-facebook web_lizar_Social_icon"></i></a><?php esc_html_e('Facebook', 'WL_ABTM_TXT_DM' ); ?> </label></th>
	...
	<tr>
		<th> <label> <a target="_blank" style="text-decoration: none;"><i class="fab fa-twitter web_lizar_Social_icon"></i></a><?php esc_html_e('Twitter', 'WL_ABTM_TXT_DM' ); ?> </label></th>
	...
	<tr>
		<th><label><a target="_blank" style="text-decoration: none;"><i class="fab fa-google-plus  web_lizar_Social_icon"  ></i></a>&nbsp <?php esc_html_e('Google', 'WL_ABTM_TXT_DM' ); ?></label></th>
	...
	<tr>
		<th><label><a target="_blank" style="text-decoration: none;"><i class="fab fa-linkedin web_lizar_Social_icon"></i></a><?php esc_html_e('LinkedIn', 'WL_ABTM_TXT_DM' ); ?> </label></th>
	...
	<tr>
		<th><label><a target="_blank" style="text-decoration: none;"><i class="fab fa-pinterest web_lizar_Social_icon"></i></a><?php esc_html_e('Pinterest', 'WL_ABTM_TXT_DM' ); ?> </label></th>
	...
	<tr>
		<th><label><a target="_blank" style="text-decoration: none;"> <i class="fab fa-instagram web_lizar_Social_icon" ></i></a><?php esc_html_e('Instagram', 'WL_ABTM_TXT_DM' ); ?> </label>
		</th>
	...
	<tr>
		<td colspan="2">
			<label class="lbl"><?php esc_html_e('Social Link Color', 'WL_ABTM_TXT_DM' );?></label>
		</td>
	</tr>
	<tr>
		<th><label> <?php esc_html_e('Color', 'WL_ABTM_TXT_DM' ); ?></label> </th>
		...
		<td>	<?php if(!isset($PGPP_Font_Style)) { $PGPP_Font_Style = "Courier New"; }?>
			<select  name="PGPP_Font_Style" id="PGPP_Font_Style" class="standard-dropdown" >
				<optgroup label="Default Fonts">
					<option value="Arial" <?php selected($PGPP_Font_Style, 'Arial' ); ?>> <?php esc_html_e( 'Arial', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Arial Black" <?php selected($PGPP_Font_Style, 'Arial Black' ); ?>> <?php esc_html_e( 'Arial Black', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Courier New" <?php selected($PGPP_Font_Style, 'Courier New' ); ?>><?php esc_html_e( 'Courier New ', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="cursive" <?php selected($PGPP_Font_Style, 'cursive' ); ?>> <?php esc_html_e( 'Cursive', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="fantasy" <?php selected($PGPP_Font_Style, 'fantasy' ); ?>> <?php esc_html_e( 'Fantasy', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Georgia" <?php selected($PGPP_Font_Style, 'Georgia' ); ?>> <?php esc_html_e( 'Georgia', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Grande"<?php selected($PGPP_Font_Style, 'Grande' ); ?>> <?php esc_html_e( 'Grande', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Helvetica Neue" <?php selected($PGPP_Font_Style, 'Helvetica Neue' ); ?>> <?php esc_html_e( 'Helvetica Neue', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Impact" <?php selected($PGPP_Font_Style, 'Impact' ); ?>> <?php esc_html_e( 'Impact', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Lucida" <?php selected($PGPP_Font_Style, 'Lucida' ); ?>> <?php esc_html_e( 'Lucida', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Lucida Console"<?php selected($PGPP_Font_Style, 'Lucida Console' ); ?>> <?php esc_html_e( 'Lucida Console', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="monospace" <?php selected($PGPP_Font_Style, 'monospace' ); ?>> <?php esc_html_e( 'Monospace', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Open Sans" <?php selected($PGPP_Font_Style, 'Open Sans' ); ?>> <?php esc_html_e( 'Open Sans', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Palatino" <?php selected($PGPP_Font_Style, 'Palatino' ); ?>> <?php esc_html_e( 'Palatino', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="sans" <?php selected($PGPP_Font_Style, 'sans' ); ?>><?php esc_html_e( 'Sans', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="sans-serif" <?php selected($PGPP_Font_Style, 'sans-serif' ); ?>><?php esc_html_e( 'Sans-Serif', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Tahoma" <?php selected($PGPP_Font_Style, 'Tahoma' ); ?>> <?php esc_html_e( 'Tahoma', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Times New Roman"<?php selected($PGPP_Font_Style, 'Times New Roman' ); ?>> <?php esc_html_e( 'Times New Roman', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Trebuchet MS" <?php selected($PGPP_Font_Style, 'Trebuchet MS' ); ?>> <?php esc_html_e( 'Trebuchet MS', 'WL_ABTM_TXT_DM' ); ?></option>
                    <option value="Verdana" <?php selected($PGPP_Font_Style, 'Verdana' ); ?>> <?php esc_html_e( 'Verdana', 'WL_ABTM_TXT_DM' ); ?></option>
				</optgroup>
	                           ...
	                           if(!is_wp_error( $response_font_api ) ) {
	                                ...
	                                if(is_array($fonts_list)) {
	                                	if(isset($fonts_list['items'])){
			                                    ...
			                                    foreach( $g_fonts as $g_font) { $font_name = $g_font['family']; ?><option value="<?php echo esc_attr($font_name); ?>" <?php selected($PGPP_Font_Style, $font_name ); ?>><?php echo esc_html($font_name); ?></option><?php 
			                                    }
		                                	} 
		                            	} else {
			...
			<p class="description">
				<?php esc_html_e('Choose a caption font style.','WL_ABTM_TXT_DM')?>
			</p>
		</td>
	</tr>
	<tr>
	<td colspan="2">
		<label class="lbl"><?php esc_html_e('Custom CSS', 'WL_ABTM_TXT_DM' ); ?></label></td>
	</tr>
	<tr>
		<th><label ><?php esc_html_e('Custom CSS', 'WL_ABTM_TXT_DM' ); ?></label> </th>
		<td>
			...
			<p class="description">
				<?php esc_html_e('Enter any custom css you want to apply on this shortcode.','WL_ABTM_TXT_DM')?>
			</p>
			<p class="custnote"><?php esc_html_e( 'Note: Please Do Not Use ', 'WL_ABTM_TXT_DM' ); ?><b><?php esc_html_e( 'Style', 'WL_ABTM_TXT_DM' ); ?></b><?php esc_html_e( 'Tag With Custom CSS', 'WL_ABTM_TXT_DM' ); ?></p>
		</td>
	</tr>
</table>
