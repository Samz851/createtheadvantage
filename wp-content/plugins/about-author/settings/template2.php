...
<table>
	<tr class="tr-center"><th><span style=" font-size: 30px;font-family: Courier New;"><?php esc_html_e('Template Style 2', 'WL_ABTM_TXT_DM' ); ?></span></th></tr>
	<tr><th></th></tr>
	<tr class="tr-center">
...
<table class="form-table">
	<th id="lbl_id">
	<label><?php esc_html_e('Upload profile Image', 'WL_ABTM_TXT_DM' ); ?></label>
	</th >
	<td id="In_put_id">
		...
		<input type="button" value="<?php esc_attr_e('Upload','WL_ABTM_TXT_DM')?>"  class="button-primary upload_image_button"/>
		...
		<p class="description"><b> <?php esc_html_e('*Upload profile image size should be 200*200 pixel maximum and 150*150 minimum', 'WL_ABTM_TXT_DM' ); ?><b>  </p>
	</td>

	<tr>
		<th id="up_load_header_img"><label><?php esc_html_e('Upload Header Background Image', 'WL_ABTM_TXT_DM' ); ?></label></th>
		...
		<p class="description"><b> <?php esc_html_e('*Upload header background image size should be 800*150 pixel maximum and 600*150 minimum', 'WL_ABTM_TXT_DM' ); ?><b>  </p>
		</td>
	</tr>
