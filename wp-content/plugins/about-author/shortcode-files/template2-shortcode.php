...
<div class="web_lizar_main_div" id="A_b_t_main_<?php echo esc_attr($p_o_s_t); ?>">
	...
	<div align="center" class="web_lizar_discription_div" id="A_b_t_discription_div_<?php echo esc_attr($p_o_s_t); ?>"  >
		<p><?php echo esc_html($About_me_dis_cription); ?></p>
	</div>
	...
	?>
	<div align="center"  id="A_b_t_web_link_div_<?php echo esc_attr($p_o_s_t); ?>" ><a  target="_blank"  class="web_lizar_web_link" href="<?php echo esc_url($About_me_web_site_url); ?>"><?php echo esc_html($About_me_web_site_name); ?></a>
	</div>
</div>