		...
		foreach($ABT_M_sets as $ABT_Settings)
			{           $p_o_s_t=$ID;
				...
				if($Tem_pl_at_e=='13') {
					...
					<div style='position: relative;  top: 40%;font-weight: bolder;font-size: 100%;'>". esc_hmtl__("Sorry! Template Style 3 Available In Pro Plugin", 'WL_ABTM_TXT_DM')."<br>". esc_html__("Template Style 1 And Template Style 2 Available In This Plugin", 'WL_ABTM_TXT_DM')."</div>
				</div>";
				}
				if($Tem_pl_at_e=='14') {
					echo "<div align='center' style='color: #b94a48;background-color: #f2dede; border-color: #b94a48;margin: 0px; display: block;height: 100px;'>
