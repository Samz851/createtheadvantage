<?php
    if ( ! function_exists( 'portfolio_breadcrumb' ) ) {
        function portfolio_breadcrumb ( $list_style = 'ol', $list_id = 'breadcrumb', $list_class = 'breadcrumb portfolio_breadcrumb', $active_class = 'active', $echo = true ) {
            // Get text domain for translations
            $theme = wp_get_theme();
            $text_domain =  $theme->get( 'portfolio' );
            ...
            if ( is_front_page() ) {
                ...
                $breadcrumb .= '<li><a href="' . esc_url( home_url( '/' ) ) . '">Home</a></li>';
            }
            ...
            // Search
            if ( is_search() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . __( 'Search', 'portfolio' ) . '</li>';
            }

            // 404
            if ( is_404() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . __( '404', 'portfolio' ) . '</li>';
            }
