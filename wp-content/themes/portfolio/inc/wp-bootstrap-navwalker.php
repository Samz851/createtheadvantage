 ...
 */
/**
 * Class Name: portfolio_WP_Bootstrap_Navwalker
...
if ( ! class_exists( 'portfolio_WP_Bootstrap_Navwalker' ) ) {
	/**
	 * portfolio_WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class portfolio_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		/**
		 * Start Level.
		 *
