...
function vc_iconpicker_type_flaticon( $icons ) {
    $flat_icons = array( 
		...
		'Web Application Icons' => array(
			...
			array( 'align-center' => 'Search(magnify, zoom, enlarge, bigger)' ),
		...
		'Flat Icons' => array(
			array('flaticon-001-picnic-basket' => 'picnic Basket'),
			array('flaticon-002-boomerang' => 'Boomerang'),
			array('flaticon-003-picnic-table' => 'picnicTable'),
			array('flaticon-004-kite' => 'Kite'),
			array('flaticon-005-knight' => 'knight'),
			array('flaticon-006-canoe' => 'canoe'),
			array('flaticon-007-golf' => 'golf'),
			array('flaticon-008-boxing-gloves' => 'boxing-gloves'),
			array('flaticon-009-skateboard' => 'skateboard'),
			array('flaticon-010-tennis' => 'tennis'),
			array('flaticon-011-slot-machine' => 'slot machine'),
			array('flaticon-012-knitting' => 'knitting'),
			array('flaticon-013-cricket-3' => 'cricket-3'),
			array('flaticon-014-cricket-2' => 'cricket-2'),
			array('flaticon-015-cricket-1' => 'cricket-1'),
			array('flaticon-016-hot-air-balloon' => 'hot-air-balloon'),
			array('flaticon-017-gamepad' => 'gamepad'),
			array('flaticon-018-ace-of-diamonds' => 'ace-of-diamonds'),
			array('flaticon-019-ace-of-clubs' => 'ace-of-clubs'),
			array('flaticon-020-ace-of-spades' => 'ace-of-spades'),
			array('flaticon-021-ace-of-hearts' => 'ace-of-hearts'),
			array('flaticon-022-dice' => 'dice'),
			array('flaticon-023-puzzle' => 'puzzle'),
			array('flaticon-024-cricket' => 'cricket'),
			array('flaticon-025-ping-pong' => 'ping-pong'),
			array('flaticon-026-american-football' => 'american-football'),
			array('flaticon-027-basketball' => 'basketball'),
			array('flaticon-028-baseball' => 'baseball'),
			array('flaticon-029-football' => 'football'),
			array('flaticon-030-volleyball' => 'volleyball'),
			array('flaticon-031-domino' => 'domino'),
			array('flaticon-032-pool' => 'pool'),
			array('flaticon-033-queen' => 'queen'),
			array('flaticon-034-king' => 'king'),
			array('flaticon-035-bishop' => 'bishop'),
			array('flaticon-036-rook' => 'rook'),
			array('flaticon-037-pawn' => 'pawn'),
			array('flaticon-038-bowling' => 'bowling'),
			array('flaticon-039-dartboard' => 'dartboard'),
			array('flaticon-040-poker' => 'poker'),
		),
 ...
 */
 add_action('vc_enqueue_font_icon_element', 'travel_enqueue_font_iconssolid');
function travel_enqueue_font_iconssolid($font){
    switch ( $font ) {
